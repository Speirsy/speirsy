// Below is a copy of FIJVideos as it was before 12/05/23 where In used useeffect twice to render two collections from the database.
// As a bit of hoarder I, and not equipped with an actual solution, didn't want to just start hacking into the code so I've kept this incase I need to go back. 
// It makes me wonder can you mute a file?  
